...
2. データモデル定義（Firestore schema）
3. Service層（認証・DB・課金・API）
4. 計測3点セット（Analytics/Crashlytics/Remote Config）
5. Riverpod ViewModel（User/Matching/Battle）
6. [★ PHASE 6] Aha Moment への最短動線 ← Sonnet担当・最優先
7. 各画面View（ロビー・ランク・フレンド等）
...
14. テスト（unit/widget/integration）
