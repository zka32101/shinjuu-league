...
final mechaCatalog = <Mecha>[
  Mecha(
    ...
    iconUrl: 'assets/images/mecha/mecha_east_flame.png',
    skins: const [],
  ...
  Mecha(
    ...
    iconUrl: 'assets/images/mecha/mecha_east_thunder.png',
    skins: const [],
  ...
  Mecha(
    ...
    iconUrl: 'assets/images/mecha/mecha_east_stone.png',
    skins: const [],
  ...
  Mecha(
    ...
    iconUrl: 'assets/images/mecha/mecha_west_frost.png',
    skins: const [],
  ...
  Mecha(
    ...
    iconUrl: 'assets/images/mecha/mecha_west_storm.png',
    skins: const [],
  ...
  Mecha(
    ...
    iconUrl: 'assets/images/mecha/mecha_west_gold.png',
    skins: const [],
