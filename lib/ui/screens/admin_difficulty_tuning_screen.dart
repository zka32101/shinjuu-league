      ...
      builder: (context, ref, child) {
        ...
        return Scaffold(
          ...
          body: adminAccessState.when(
            data: (state) {
              // Check if user has permission to view difficulty settings
              final canViewDifficulty = ref
                  .read(adminAccessViewModelProvider.notifier)
                  .hasPermission(AdminPermission.viewDifficulty);

              if (!canViewDifficulty) {
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        'You do not have permission to view difficulty settings.',
